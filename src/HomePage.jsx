            ...
            <div className="flex gap-4">
                <div className="flex-1">
                            ...
                            <>
                                ...
                                {weeklySchedules.length === 0 ? (
                                    ...
                                    weeklySchedules.map(slot => (
                                        <div
                                            key={slot.id}
                                            className={`${subjectColors[slot.subject] || 'bg-blue-50'} p-3 rounded-lg mb-2 shadow-sm cursor-pointer`}
                                                ...
                                                {DAYS_OF_WEEK.map(day => {
                                                    ...
                                                    return (
                                                        <td key={day} className="border px-2 py-1 text-center align-top h-12">
                                                            {slot ? (
                                                                <div
                                                                    className={`${subjectColors[slot.subject] || 'bg-blue-100'} p-2 rounded cursor-pointer`}
                                                                    onClick={() => handleLessonClick(slot)}
                                                                >
                    ...
                    {showStudentList && (
                        <div className="mt-4 bg-white p-4 shadow rounded">
                            <h3 className="text-lg font-bold text-blue-700 mb-2">Students in this Lesson:</h3>
                ...
                <div className="w-1/3">
                    ...
                    <div className="mt-4 space-y-2">
                        {notes.map(note => (
                            <div key={note.id} className="bg-white p-2 shadow rounded flex justify-between items-center text-sm">
                                <div>
