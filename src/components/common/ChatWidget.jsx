...
const ChatWidget = () => {
    ...
    return (
        <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
            {/* Chat Bubble */}
            <div className={`transition-opacity duration-300 ease-in-out ${isOpen ? "opacity-100 scale-100" : "opacity-0 scale-95 pointer-events-none"} transform origin-bottom`}>
            ...
            <button
                ...
                className="w-14 h-14 bg-blue-600 hover:bg-blue-700 text-white rounded-full shadow-xl flex items-center justify-center text-xl transition"
