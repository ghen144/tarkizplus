...
const SESSION_ICONS = {
    Group: <Users className={iconClass}/>,
    Private: <User className={iconClass}/>,
};
                ...
                `}
                            ...
                            >
                                ...
                                <div className="flex flex-col gap-2 items-end">
                                    ...
                                    >
                                        {note.pinned ? (
                                            <Pin className="h-5 w-5 stroke-[2] animate-bounce"/>
                                        ) : (
...
const HomePage = () => {
    ...
    return (
        <div
            className="flex flex-row w-full min-h-screen bg-gradient-to-tr from-blue-50 via-white to-blue-100 p-8 gap-6 font-sans">
            {/* Main schedule area */}
