...
const LoginPage = () => {
    ...
    return (
        ...
        >
            <div
                className="w-full max-w-md p-8 bg-white/60 backdrop-blur-xl rounded-3xl shadow-2xl ring-1 ring-white/20 space-y-6 transition-all duration-300">
                {/* Logo */}
                ...
                <div className="mt-6 text-center">
                    ...
                    <div className="flex justify-center gap-2">
                        <button onClick={() => changeLanguage('en')} className="border px-3 py-1 rounded text-sm">EN
                        </button>
                        <button onClick={() => changeLanguage('ar')} className="border px-3 py-1 rounded text-sm">ع
                        </button>
                        <button onClick={() => changeLanguage('he')} className="border px-3 py-1 rounded text-sm">ע
                        </button>
                    </div>
                </div>
            </div>
